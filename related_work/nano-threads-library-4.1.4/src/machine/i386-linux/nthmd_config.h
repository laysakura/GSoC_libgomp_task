/* nthmd_config.h -- i-386 header support.
 * -------------------------------------------------------------------
...
#define NTHMD_MAX_WORD_VALUE					0xFFFFFFFFL
#define NTHMD_DEFAULT_MAIN_LAYOUT_BASE			0xC0000000L
#define NTHMD_DEFAULT_MAIN_STACK_SIZE			0x007F0
#define NTHMD_DEFAULT_MAIN_GUARD_SIZE			0x00008
#define NTHMD_DEFAULT_MAIN_DESC_SIZE			0x00008
#define NTHMD_DEFAULT_AUX_STACK_SIZE			0x007F0
#define NTHMD_DEFAULT_AUX_GUARD_SIZE			0x00008
#define NTHMD_DEFAULT_AUX_DESC_SIZE				0x00008

#if 0
#define NTHMD_DEFAULT_DESCRIPTOR_SIZE		0x8
#define NTHMD_DEFAULT_MAIN_STACK_LAYOUT_BASE	0xC0000000L 
#define NTHMD_DEFAULT_STACK_LAYOUT_SIZE			0x800
#define NTHMD_DEFAULT_MAIN_STACK_LAYOUT_SIZE	0x800
#define NTHMD_DEFAULT_MAIN_STACK_SIZE			0x7F0
#define NTHMD_DEFAULT_AUX_STACK_LAYOUT_BASE		0x90000000L 
#define NTHMD_DEFAULT_AUX_STACK_LAYOUT_SIZE		0x800
#define NTHMD_DEFAULT_AUX_STACK_SIZE			0x7F0
#define NTHMD_DEFAULT_DESCRIPTOR_SIZE			0x8
#endif
/* ******************************************************************
 ...
 * -----------------------------------------------------------------*/
#define NTH_QT_USERF_INDEX		(0)
#define NTH_QT_ARGT_INDEX		(1)
#define NTH_QT_CLEANUP_INDEX	(2)
#define NTH_QT_START_INDEX		(4)
/* -------------------------------------------------------------------
 * NTH_QT_ARGS_MD0:
 * -----------------------------------------------------------------*/
...
#define NTH_QT_ARGS_MD1(sto) \
  (NTH_QT_SPUT (sto, NTH_QT_START_INDEX, nth_qt_start))
/* ******************************************************************
 * GENERAL DEFINES
 * *****************************************************************/
/* -----------------------------------------------------------------*/
