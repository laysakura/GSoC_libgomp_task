/* nthmd_config.h -- PowerPC32 header support.
 * -------------------------------------------------------------------
...
#define NTHMD_DEFAULT_MAIN_LAYOUT_BASE                  0x70000000L
#define PAGE_SIZE_IS_64_KBYTES
#ifdef PAGE_SIZE_IS_64_KBYTES
#define NTHMD_DEFAULT_MAIN_STACK_SIZE			   0x01FFL
#define NTHMD_DEFAULT_MAIN_GUARD_SIZE                      0x0001L
#define NTHMD_DEFAULT_MAIN_DESC_SIZE                       0x0001L
#define NTHMD_DEFAULT_AUX_STACK_SIZE                       0x01FFL
#define NTHMD_DEFAULT_AUX_GUARD_SIZE                       0x0001L
#define NTHMD_DEFAULT_AUX_DESC_SIZE                        0x0001L
#else
 ...
 * -----------------------------------------------------------------*/
#define NTH_QT_STKBASE	((6+18+16)*4)
/* -------------------------------------------------------------------
