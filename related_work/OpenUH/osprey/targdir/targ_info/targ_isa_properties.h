...
#define PROP_mcode            0x20ULL
#define PROP_opcode_1         0x40ULL
#define PROP_opcode_2         0x80ULL
#define PROP_opcode_3         0x100ULL
#define PROP_opcode_4         0x200ULL
#define PROP_load             0x400ULL
#define PROP_load_ext         0x800ULL
#define PROP_x87              0x1000ULL
#define PROP_mmx              0x2000ULL
#define PROP_load_exe         0x4000ULL
#define PROP_load_exe_store   0x8000ULL
#define PROP_nt_store         0x10000ULL
#define PROP_store            0x20000ULL
#define PROP_prefetch         0x40000ULL
#define PROP_xfer             0x80000ULL
#define PROP_call             0x100000ULL
#define PROP_cond             0x200000ULL
#define PROP_avx              0x400000ULL
#define PROP_cond_set         0x800000ULL
#define PROP_cond_move        0x1000000ULL
#define PROP_same_res         0x2000000ULL
#define PROP_unalign_ld       0x4000000ULL
#define PROP_unalign_store    0x8000000ULL
#define PROP_unknown_memdata  0x10000000ULL
#define PROP_unknown_addr     0x20000000ULL
#define PROP_iadd             0x40000000ULL
#define PROP_isub             0x80000000ULL
#define PROP_imul             0x100000000ULL
#define PROP_idiv             0x200000000ULL
#define PROP_flop             0x400000000ULL
#define PROP_fadd             0x800000000ULL
#define PROP_fsub             0x1000000000ULL
#define PROP_fmul             0x2000000000ULL
#define PROP_noop             0x4000000000ULL
#define PROP_dummy            0x8000000000ULL
#define PROP_fdiv             0x10000000000ULL
#define PROP_sqrt             0x20000000000ULL
#define PROP_ior              0x40000000000ULL
#define PROP_jump             0x80000000000ULL
#define PROP_ijump            0x100000000000ULL
#define PROP_ixor             0x200000000000ULL
#define PROP_iand             0x400000000000ULL
#define PROP_icmp             0x800000000000ULL
#define PROP_simulated        0x1000000000000ULL
#define PROP_commutative      0x2000000000000ULL
#define PROP_vector_op        0x4000000000000ULL
#define PROP_x86_style        0x8000000000000ULL
#define PROP_read_rflags      0x10000000000000ULL
#define PROP_side_effects     0x20000000000000ULL
#define PROP_var_opnds        0x40000000000000ULL
#define PROP_fastpath_db      0x80000000000000ULL
#define PROP_vector_lo_loadstore 0x100000000000000ULL
#define PROP_vector_high_loadstore 0x200000000000000ULL
#define PROP_vector_packed_single 0x400000000000000ULL
#define PROP_vector_packed_double 0x800000000000000ULL
#define PROP_non_destructive  0x1000000000000000ULL
#define PROP_is4_reg          0x2000000000000000ULL
#define PROP_prefix_lock      0x4000000000000000ULL
...
#define TOP_is_mcode(t)	 (ISA_PROPERTIES_flags[(INT)t] & PROP_mcode)
#define TOP_is_opcode_1(t)	 (ISA_PROPERTIES_flags[(INT)t] & PROP_opcode_1)
#define TOP_is_opcode_2(t)	 (ISA_PROPERTIES_flags[(INT)t] & PROP_opcode_2)
#define TOP_is_opcode_3(t)	 (ISA_PROPERTIES_flags[(INT)t] & PROP_opcode_3)
#define TOP_is_opcode_4(t)	 (ISA_PROPERTIES_flags[(INT)t] & PROP_opcode_4)
...
#define TOP_is_avx(t)	 (ISA_PROPERTIES_flags[(INT)t] & PROP_avx)
...
#define TOP_is_fastpath_db(t)	 (ISA_PROPERTIES_flags[(INT)t] & PROP_fastpath_db)
...
#define TOP_is_is4_reg(t)	 (ISA_PROPERTIES_flags[(INT)t] & PROP_is4_reg)
